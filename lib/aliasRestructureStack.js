...
const stepFunctions = require('./stackops/stepFunctions');
...
module.exports = {
	...
	aliaHandleStepFunctions(currentTemplate, aliasStackTemplates, currentAliasStackTemplate) {
		return stepFunctions.call(this, currentTemplate, aliasStackTemplates, currentAliasStackTemplate);
	},
	...
	aliasRestructureStack(currentTemplate, aliasStackTemplates, currentAliasStackTemplate) {
		...
		.spread(this.aliaHandleStepFunctions)
